...
in {
  ...
  home.file."Pictures/wallpapers/monitor_state.json".source = config.lib.file.mkOutOfStoreSymlink "/home/sewer/nixos/users/sewer/home-manager/desktop/hyprland/programs/waybar/scripts/wallpaper/state/monitor_state.json";
  home.file."Pictures/wallpapers/wallpaper_collection.json".source = config.lib.file.mkOutOfStoreSymlink "/home/sewer/nixos/users/sewer/home-manager/desktop/hyprland/programs/waybar/scripts/wallpaper/state/wallpaper_collection.json";
