...
# maroon = oklch(0.7702 0.1024 14.37)
# flamingo = oklch(0.8629 0.0479 18.12)
# rosewater = oklch(0.9105 0.0286 31.13)
# peach = oklch(0.7988 0.1061 49.64)
# yellow = oklch(0.879 0.0744 84.75)
# green = oklch(0.835 0.1079 138.15)
# teal = oklch(0.8214 0.0755 184.1)
# sky = oklch(0.8369 0.0719 209.37)
# sapphire = oklch(0.7851 0.0845 228.38)
# blue = oklch(0.7497 0.1101 263.81)
# lavender = oklch(0.8166 0.091 277.31)
# mauve = oklch(0.7715 0.1259 303.9)
# pink = oklch(0.8608 0.083 336.18)
